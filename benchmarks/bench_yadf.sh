...
for d in run_*/; do mv -- "$d" "results/yadf_adm_${d#./}"; done
...
for d in run_*/; do mv -- "$d" "results/yadf_com_${d#./}"; done
...
for d in run_*/; do mv -- "$d" "results/yadf_prf_${d#./}"; done
...
for d in run_*/; do mv -- "$d" "results/yadf_stb_${d#./}"; done
